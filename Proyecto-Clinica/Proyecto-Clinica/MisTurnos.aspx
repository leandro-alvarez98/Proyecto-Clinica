...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <asp:GridView ID="DGV_Turnos_totales" CssClass="table table-dark table-hover PAD_TOP" OnRowCommand="DGV_Turnos_totales_RowCommand"  runat="server" AutoGenerateColumns="false" AutoPostBack="true" EnableViewState="true">
                        <Columns>
                ...
                <%{%>
                <div class="container form_top containerbott">
                    <asp:GridView ID="dgv_Turnos" CssClass="table table-dark table-hover PAD_TOP" OnSelectedIndexChanged="dgv_Turnos_SelectedIndexChanged" runat="server" AutoGenerateColumns="false">
                        <Columns>
                            <asp:BoundField HeaderText="Turno #" DataField="Id" />
                            <asp:BoundField HeaderText="Fecha" DataField="Fecha" DataFormatString="{0:yyyy-MM-dd}" />
                            <asp:BoundField HeaderText="Hora" DataField="Horario" />
                            ...
                            <asp:BoundField HeaderText="DNI Paciente" DataField="Dni_Paciente" />
                            <asp:BoundField HeaderText="Estado" DataField="Estado" />
                            <asp:CommandField ShowSelectButton="true" SelectText="Cancelar" HeaderText="*" />
                        </Columns>
                    </asp:GridView>
                </div>
                 <%}%>
