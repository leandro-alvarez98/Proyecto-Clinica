    ...
    <div class="container containerbott">
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="mb-2">
                                        <asp:Label ID="lblContraseñaActualizada" runat="server" Class="form-label" Text="Contraseña actualizada con exito!"></asp:Label>
                                        <asp:Label ID="lblAceptarIngresar" runat="server" Class="form-label" Text="Por favor, vuelva a iniciar la sesion"></asp:Label>
