...
FROM PACIENTES P 
RIGHT JOIN OBSERVACIONES O ON P.ID_PACIENTE = O.ID_PACIENTE
...
CREATE TABLE TURNOS_PACIENTES (
    ID_TURNO_PACIENTE INT NOT NULL PRIMARY KEY IDENTITY(1,1),
...
-- Inserción en la tabla TURNOS_PACIENTES
INSERT INTO TURNOS_PACIENTES (ID_TURNO, ID_PACIENTE)
VALUES
    (1, 1),
    (1, 2),
    (3, 3),
