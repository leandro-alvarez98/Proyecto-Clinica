...
-- QUERY PARA TRAER UN SOLO MEDICO MEDIANTE ID
	Select ID_MEDICO, NOMBRE, TELEFONO, DIRECCION, FECHA_NACIMIENTO, MAIL, ESTADO from MEDICOS WHERE ID_MEDICO = @IDMEDICO
...
--QUERY DE LOS TURNOS DE UN MEDICO MEDICO
	SELECT ID_TURNO, ID_MEDICO, ID_PACIENTE, FECHA, HORA_INICIO, HORA_FIN, ESTADO FROM TURNOS WHERE @IDMEDICO = ID_MEDICO
